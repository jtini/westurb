...
const items = [
    ...
    'The Sustainable Denver Summit, an annual event attracting over 1,000 participants, was created and grew to become the sustainability event of the year in Colorado.',
