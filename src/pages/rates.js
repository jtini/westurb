    ...
    return (
        <Layout>
            ...
            <div className="container">
                ...
                <p className="text--subdued">We operate with daily, weekly and fixed price rates. Which we use will depend on the nature and duration of the project. For example, a presentation or single-day consultation will normally be charged at the daily rate. A more extended interaction - for example, spending several days at a client office - will be at the weekly rate. An ongoing relationship will likely be at a fixed price. Hourly rates provided upon request.</p>
